export default {
    ...
    "adminViews": {
        ...
        "systemConfig": {
            ...
            "security": {
                ...
                "ipRegisterLimit": {
                    "title": "IP登録制限",
                    "description": "開設後、IP登録口座がルール要件を満たしている場合、IPの判断はCDNまたは事前エージェントのために問題を引き起こす可能性があることに注意してください。"
                },
                "registerTimes": {
                    "title": "頻度",
            ...
            "sendMail": {
                "common": {
                    ...
                    "sendTestMailShallow": "電子メールは、現在ログインしている管理者のメールアドレスに送信されます",
        ...
        "payConfig": {
            "title": "支払い設定",
            "description": "サポートされているすべての支払い方法は、現在、支払いバッグの支払いのみがサポートされていますが、最初に他の支払い方法を設定し、プロジェクトをさらに改善するかどうかを確認できます。更新ログでサポートされています。",
            "attention": {
                "title": "注意すべきこと",
        ...
        "groupMgr": {
            "title": "権限管理",
            "description": "適切なグループは、異なるサブスクリプションレベルをマークするために使用され、同じレベルのサブスクライバープランを簡単に管理できますが、1つの適切なグループで異なるサイズを管理できます。",
            "common": {
        ...
        "planMgr": {
            ...
            "mention": {
                ...
                "updateFailure": "サブスクリプションの更新に失敗しました",
                "deleteSuccess": "計画は正常に削除されました",
                "deleteFailure": "計画の削除は失敗しました"
            },
            "form": {
        ...
        "couponMgr": {
            "title": "クーポン管理",
            "description": "ここでは、特定のフェスティバルなどにいくつかのクーポンを追加できます。これにより、ユーザーは注文するときに使用できるようにし、設定した割合に応じて割引を提供できます。",
        ...
        "secondary": {
            ...
            "mention": {
                ...
                "imageRequire": {
                    ...
                    "p2": "画像の長さの比率は1：1（正方形）です。異なる比率の場合、中央の正方形にカットされ、過剰が削除されます。",
    ...
    "userKeys": {
        ...
        "copyFailure": "失敗のコピー",
        "hoverCopiedSuccessMention": "正常にコピーします"
    },
    "userOrders": {
        "myOrders": "私の注文",
    ...
    "userTickets": {
        "description": "使用に関する問題が発生した場合は、ここで作業順序を提出してください。",
        "ticketId": "＃",
    ...
    "welcome": {
        "A": {
            ...
            "welcomeTo": "いらっしゃいませ",
            "welcomeToSub": "郡の長いトンネルを通過するのは雪の国です。 夜空の下では、地球は白く、列車は信号ステーションの前で止まりました。 「ここで、川谷ヤスナリは、ほぼケチな簡潔な言葉で「雪の国」をキックオフしました。",
            "startingUse": "始めましょう",
            "whyUs": "なぜ私たちを選ぶのか",
            ...
            "mgr": "効率的な管理",
            "mgrSub": "1つのユーザーインターフェイスは、完全でリッチな管理機能を備えたすべてのキーを管理し、問題を公開するために購読することを心配する必要はありません",
            "fast": "便利で速い",
