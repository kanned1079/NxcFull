...
import (
	...
	"log"
	"net"
	"orderHandleServices/api/proto"
	"orderHandleServices/internal/config/local"
	"orderHandleServices/internal/services"
)
...
func RunGRPCServer() {
	...
	s := services.NewOrderHandleServices()
	//proto.Reg(grpcServer, documentServices)
	proto.RegisterOrderHandleServiceServer(grpcServer, s)
