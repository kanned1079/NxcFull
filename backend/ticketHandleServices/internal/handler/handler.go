...
import (
	...
	"log"
	"net"
	"ticketHandleServices/api/proto"
	"ticketHandleServices/internal/config/local"
	"ticketHandleServices/internal/services"
)
...
func RunGRPCServer() {
	...
	s := services.NewTicketHandleServices()
	//proto.Reg(grpcServer, documentServices)
	proto.RegisterTicketHandleServiceServer(grpcServer, s)
