...
var file_settings_proto_rawDesc = []byte{
	...
	0x2e, 0x4d, 0x79, 0x61, 0x70, 0x70, 0x52, 0x05, 0x6d, 0x79, 0x61, 0x70, 0x70, 0x32, 0xa2, 0x02,
...
var file_settings_proto_goTypes = []any{
	...
	nil,                                // 17: settings.CategorySettings.OptionsEntry
}
var file_settings_proto_depIdxs = []int32{
	17, // 0: settings.CategorySettings.options:type_name -> settings.CategorySettings.OptionsEntry
	...
	2,  // 12: settings.SettingsService.UpdateSingleOption:output_type -> settings.UpdateSingleOptionResponse
	4,  // 13: settings.SettingsService.GetStartTheme:output_type -> settings.GetStartThemeResponse
	7,  // 14: settings.SettingsService.GetSystemSettings:output_type -> settings.GetSystemSettingsResponse
