...
const (
	...
	KeyService_CheckActivationStatusIntervalReq_FullMethodName = "/key.KeyService/CheckActivationStatusIntervalReq"
...
type KeyServiceClient interface {
	...
	CheckActivationStatusIntervalReq(ctx context.Context, in *CheckActivationStatusIntervalReqRequest, opts ...grpc.CallOption) (*CheckActivationStatusIntervalReqResponse, error)
...
func (c *keyServiceClient) CheckActivationStatusIntervalReq(ctx context.Context, in *CheckActivationStatusIntervalReqRequest, opts ...grpc.CallOption) (*CheckActivationStatusIntervalReqResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckActivationStatusIntervalReqResponse)
	err := c.cc.Invoke(ctx, KeyService_CheckActivationStatusIntervalReq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeyServiceServer interface {
	...
	CheckActivationStatusIntervalReq(context.Context, *CheckActivationStatusIntervalReqRequest) (*CheckActivationStatusIntervalReqResponse, error)
...
func (UnimplementedKeyServiceServer) CheckActivationStatusIntervalReq(context.Context, *CheckActivationStatusIntervalReqRequest) (*CheckActivationStatusIntervalReqResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckActivationStatusIntervalReq not implemented")
}
...
func _KeyService_CheckActivationStatusIntervalReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckActivationStatusIntervalReqRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyServiceServer).CheckActivationStatusIntervalReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeyService_CheckActivationStatusIntervalReq_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyServiceServer).CheckActivationStatusIntervalReq(ctx, req.(*CheckActivationStatusIntervalReqRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KeyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckActivationStatusIntervalReq",
			Handler:    _KeyService_CheckActivationStatusIntervalReq_Handler,
		},
		{
