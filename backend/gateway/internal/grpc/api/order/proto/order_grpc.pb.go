...
const (
	...
	OrderService_QueryTopUpOrderStatus_FullMethodName     = "/order.OrderService/QueryTopUpOrderStatus"
...
type OrderServiceClient interface {
	...
	QueryTopUpOrderStatus(ctx context.Context, in *QueryTopUpOrderStatusRequest, opts ...grpc.CallOption) (*QueryTopUpOrderStatusResponse, error)
	// 管理员的请求
...
func (c *orderServiceClient) QueryTopUpOrderStatus(ctx context.Context, in *QueryTopUpOrderStatusRequest, opts ...grpc.CallOption) (*QueryTopUpOrderStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryTopUpOrderStatusResponse)
	err := c.cc.Invoke(ctx, OrderService_QueryTopUpOrderStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	QueryTopUpOrderStatus(context.Context, *QueryTopUpOrderStatusRequest) (*QueryTopUpOrderStatusResponse, error)
	// 管理员的请求
...
func (UnimplementedOrderServiceServer) QueryTopUpOrderStatus(context.Context, *QueryTopUpOrderStatusRequest) (*QueryTopUpOrderStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryTopUpOrderStatus not implemented")
}
...
func _OrderService_QueryTopUpOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryTopUpOrderStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).QueryTopUpOrderStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_QueryTopUpOrderStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).QueryTopUpOrderStatus(ctx, req.(*QueryTopUpOrderStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryTopUpOrderStatus",
			Handler:    _OrderService_QueryTopUpOrderStatus_Handler,
		},
		{
