...
const (
	...
	SettingsService_GetSendMailTemplateFillContent_FullMethodName   = "/settings.SettingsService/GetSendMailTemplateFillContent"
)
...
type SettingsServiceClient interface {
	...
	// Mail服务
	GetSendMailTemplateFillContent(ctx context.Context, in *GetSendMailTemplateFillContentRequest, opts ...grpc.CallOption) (*GetSendMailTemplateFillContentResponse, error)
}
...
func (c *settingsServiceClient) GetSendMailTemplateFillContent(ctx context.Context, in *GetSendMailTemplateFillContentRequest, opts ...grpc.CallOption) (*GetSendMailTemplateFillContentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSendMailTemplateFillContentResponse)
	err := c.cc.Invoke(ctx, SettingsService_GetSendMailTemplateFillContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SettingsServiceServer interface {
	...
	// Mail服务
	GetSendMailTemplateFillContent(context.Context, *GetSendMailTemplateFillContentRequest) (*GetSendMailTemplateFillContentResponse, error)
...
func (UnimplementedSettingsServiceServer) GetSendMailTemplateFillContent(context.Context, *GetSendMailTemplateFillContentRequest) (*GetSendMailTemplateFillContentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSendMailTemplateFillContent not implemented")
}
...
func _SettingsService_GetSendMailTemplateFillContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSendMailTemplateFillContentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingsServiceServer).GetSendMailTemplateFillContent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SettingsService_GetSendMailTemplateFillContent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingsServiceServer).GetSendMailTemplateFillContent(ctx, req.(*GetSendMailTemplateFillContentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SettingsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSendMailTemplateFillContent",
			Handler:    _SettingsService_GetSendMailTemplateFillContent_Handler,
		},
	},
