...
var file_settings_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0xec, 0x08, 0x0a, 0x0f,
	...
	0x59, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	0x4d, 0x73, 0x67, 0x12, 0x21, 0x2e, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x47,
	0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x73, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x4d,
	0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f,
...
var file_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_settings_proto_goTypes = []any{
	...
	nil,                                              // 31: settings.CategorySettings.OptionsEntry
}
var file_settings_proto_depIdxs = []int32{
	31, // 0: settings.CategorySettings.options:type_name -> settings.CategorySettings.OptionsEntry
	...
	2,  // 19: settings.SettingsService.UpdateSingleOption:output_type -> settings.UpdateSingleOptionResponse
	4,  // 20: settings.SettingsService.GetStartTheme:output_type -> settings.GetStartThemeResponse
	7,  // 21: settings.SettingsService.GetSystemSettings:output_type -> settings.GetSystemSettingsResponse
	18, // 22: settings.SettingsService.AddPaymentMethod:output_type -> settings.AddPaymentMethodResponse
	20, // 23: settings.SettingsService.GetAllPaymentSettingsKv:output_type -> settings.GetAllPaymentSettingsKvResponse
	28, // 24: settings.SettingsService.GetPaymentMethodDetailsByName:output_type -> settings.GetPaymentMethodDetailsByNameResponse
	22, // 25: settings.SettingsService.EditPaymentSettingsBySystemName:output_type -> settings.EditPaymentSettingsBySystemNameResponse
	24, // 26: settings.SettingsService.EnablePaymentSettingBySystemName:output_type -> settings.EnablePaymentSettingBySystemNameResponse
	26, // 27: settings.SettingsService.DeletePaymentSettingBySystemName:output_type -> settings.DeletePaymentSettingBySystemNameResponse
	30, // 28: settings.SettingsService.GetInviteUserMsg:output_type -> settings.GetInviteUserMsgResponse
